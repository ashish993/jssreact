...
var manifest_manager_1 = require("../manifest-manager");
...
function createDefaultDisconnectedServer(options) {
    ...
    return manifestManager
        ...
        var layoutService = layout_service_1.createDisconnectedLayoutService({
            manifest: manifest,
        ...
        var dictionaryService = dictionary_service_1.createDisconnectedDictionaryService({
            manifest: manifest,
            manifestLanguageChangeCallback: manifestManager.getManifest,
        });
