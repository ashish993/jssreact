...
exports.verifySetup = function () {
    if (!fs_1.default.existsSync(setup_1.userConfigPath)) {
        ...
        var runSetup = readline_sync_1.default.keyInYN('This command requires a Sitecore connection. Would you like to configure the connection?');
        if (!runSetup) {
        ...
        var continueCommand = readline_sync_1.default.keyInYN(chalk_1.default.yellow('Is the config deployed?'));
        if (!continueCommand) {
