...
exports.default = (function (args) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                content = args.content, pipelines = args.pipelines;
                actualContent = content;
                if (!(actualContent.children && actualContent.children.length > 0)) return [3 /*break*/, 2];
                ...
                promises = actualContent.children.map(function (nestedContent) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        pipelineArgs_1.content = nestedContent;
                        pipeline_1.args = pipelineArgs_1;
                        return [2 /*return*/, sitecore_pipelines_1.runPipeline(pipeline_1)];
                    });
                }); });
