        ...
        switch (_a.label) {
            case 0:
                ...
                pipelineArgs = __assign(__assign({}, pipeline.args), { templates: templates,
                    ...
                    pipelines: pipelines });
                _i = 0, contentData_1 = contentData;
                _a.label = 1;
            case 1:
                if (!(_i < contentData_1.length)) return [3 /*break*/, 4];
                content = contentData_1[_i];
...
exports.default = (function (args) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                content = args.content, pipelines = args.pipelines, components = args.components, templates = args.templates;
                return [4 /*yield*/, generateContentItems(content, templates, components, pipelines)];
            case 1:
