        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, pipelineResult.media];
            }
        });
    });
};
exports.default = (function (args) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = args.pipelineResult, items = _a.items, templates = _a.templates;
                return [4 /*yield*/, generateMedia({ items: items, templates: templates, pipelines: args.pipelines })];
            case 1:
                media = _b.sent();
