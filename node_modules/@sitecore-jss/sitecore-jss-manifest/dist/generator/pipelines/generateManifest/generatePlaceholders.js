...
var generatePlaceholders = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    pipelineResult = _b.sent();
                    return [2 /*return*/, pipelineResult.placeholders];
            }
        });
    });
};
exports.default = (function (args) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = args.pipelineResult, items = _a.items, renderings = _a.renderings;
                return [4 /*yield*/, generatePlaceholders(__assign({ items: items,
                        renderings: renderings, rootPlaceholders: args.pipelineResult.rootPlaceholders }, args))];
            case 1:
