...
var GraphQLRequestClient = /** @class */ (function () {
     ...
     */
    function GraphQLRequestClient(endpoint) {
    ...
    GraphQLRequestClient.prototype.request = function (query, variables) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requestInternal(query, variables)];
                    case 1:
                        result = _a.sent();
     ...
     * @param {Object} variables graphql variables
     */
    GraphQLRequestClient.prototype.requestInternal = function (query, variables) {
        var client = new graphql_request_1.GraphQLClient(this.endpoint);
