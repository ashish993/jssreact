...
var pipeline = pipelineFactory_1.pipelineFactory.create('Sample Pipeline');
...
var runner = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, utils_1.initCompilers(compilers)
                .then(function () {
                return configLoader_1.configLoader({ fileGlobs: ['../test/pipelines/**/*.config.js'], workingDirectory: __dirname });
            })
                ...
                .then(function (config) {
                var pipeline0 = config.pipeline0;
                pipeline0.args.arg0 = 'testArg';
                return pipeline_1.run(pipeline0);
            })];
    });
}); };
runner()
    ...
    .then(function () { return pipeline.run(); })
    .then(function (result) {
    console.log(JSON.stringify(result, null, 2));
})
    .catch(function (err) {
